...
fclose(out);
out = fopen("bits.txt", "w+");
fclose(out);
printf("\n\n Secure Medical File Sharing System \n");
printf("------------------------------------------- \n\n");
create16Keys();
...
fclose(fptr);
char o;
printf("\n\n Do you want to access the file press Y for yes and N for no: ");
scanf("%c",&o);
if(o=='y'||o=='Y')
{
...
fclose(fptr);
char xq;
printf("\n\nDo you want to Decrypt the File press Y for yes and N for no: ");
scanf("%s",&xq);
if(xq=='y'||xq=='Y')
{
...
{
printf("\n\nThe Decryption is unsuccessful \n");
printf("----------------------------------\n\n");
return 0;
}
}
